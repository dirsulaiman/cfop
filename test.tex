...
\newcommand{\pll}[1]{\includegraphics[height=1.5cm]{images/pll/{#1}}}
...
\newcommand{\algorithm}[1]{
    \fontfamily{pbk}\selectfont %qcr
    \SetTracking[spacing={-100*,-100*,}]{encoding=*}{0} %kerapatan karakter
    \textls{#1}
}
...
\newcommand{\headlights}{\algorithm{ }}
\newcommand{\headlightsI}{\algorithm{\yrotate{y'} \xrotate{x'} (\redfamily{R U R'}) \key{D} (R U' R') \key{D'}}}
\newcommand{\lshape}{\algorithm{ }}
\newcommand{\lshapeI}{\algorithm{\xrotate{x'} (R U' R') \key{D} (\redfamily{R U R'}) \key{D'}}}
\newcommand{\tshape}{\algorithm{ }}
\newcommand{\tshapeI}{\algorithm{ }}


\newcommand{\pshape}{\algorithm{f (\redfamily{R U R' U'}) f'}}
\newcommand{\pshapeI}{\algorithm{ }}
\newcommand{\ishape}{\algorithm{F (\redfamily{R U R' U'}) F}}
\newcommand{\ishapeI}{\algorithm{ }}
